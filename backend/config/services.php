    ...
    'sourcing' => [
        ...
        'platforms' => [
            ...
            'aliexpress' => [
                ...
                'token_url' => env('ALIEXPRESS_OAUTH_TOKEN_URL', 'https://openapi-api.alibaba.com/rest/auth/token/create'),
                'refresh_url' => env('ALIEXPRESS_OAUTH_REFRESH_URL', 'https://openapi-api.alibaba.com/rest/auth/token/refresh'),
                'api_base_url' => env('ALIEXPRESS_API_BASE_URL', 'https://openapi-api.alibaba.com'),
