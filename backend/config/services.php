    ...
    'sourcing' => [
        ...
        'platforms' => [
            'alibaba' => [
                ...
                'token_url' => env('ALIBABA_OAUTH_TOKEN_URL', 'https://api.alibaba.com/rest/auth/token/create'),
                'refresh_url' => env('ALIBABA_OAUTH_REFRESH_URL', 'https://api.alibaba.com/rest/auth/token/refresh'),
            ...
            'aliexpress' => [
                ...
                'token_url' => env('ALIEXPRESS_OAUTH_TOKEN_URL', 'https://api.alibaba.com/rest/auth/token/create'),
                'refresh_url' => env('ALIEXPRESS_OAUTH_REFRESH_URL', 'https://api.alibaba.com/rest/auth/token/refresh'),
