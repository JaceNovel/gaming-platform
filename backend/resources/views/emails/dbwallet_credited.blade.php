  ...
  <body style="margin:0;padding:0;background:#0b1220;color:#e2e8f0;font-family:Arial,Helvetica,sans-serif;">
    <div style="max-width:600px;margin:0 auto;padding:24px;">
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:18px;">
        @if(!empty($logo))
          <img src="{{ $logo }}" alt="PRIME Gaming" style="height:36px;width:auto;" />
        @endif
        <div style="font-weight:700;letter-spacing:0.4px;">PRIME Gaming</div>
      </div>
      ...
      <p style="margin:16px 0 0 0;opacity:0.6;font-size:12px;">© {{ date('Y') }} PRIME Gaming</p>
    </div>
  </body>
</html>
