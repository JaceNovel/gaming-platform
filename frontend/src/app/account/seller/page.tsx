      ...
      >
        ...
        >
          <div
            className={
              isMobileCreatePage
                ? "sticky top-0 z-20 flex items-start justify-between gap-3 border-b border-white/10 bg-[#05020f]/95 px-4 py-4 backdrop-blur"
          ...
          >
            <div>
              ...
              <h3 className={"mt-1 font-semibold text-white " + (isMobileCreatePage ? "text-3xl" : "text-xl")}>{isEdit ? "Modifier l'annonce" : "Créer une annonce"}</h3>
              {!isMobileCreatePage ? (
                <>
            ...
            <div className="flex items-center gap-2">
              {isMobileCreatePage ? (
                <button
                  ...
                  className="inline-flex items-center rounded-2xl border border-white/10 bg-white/5 px-4 py-2 text-sm font-semibold text-white/80 hover:bg-white/10"
                >
                  Retour
                </button>
              ) : null}
