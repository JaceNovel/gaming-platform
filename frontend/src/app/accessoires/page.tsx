                          ...
                          return (
                            ...
                            >
                              <div className="flex gap-4">
                                ...
                                <div className="relative h-[148px] w-[132px] flex-none overflow-hidden rounded-2xl border border-white/10 bg-black/30">
                                  {imgSrc ? (
                                    // eslint-disable-next-line @next/next/no-img-element
                                    <img src={imgSrc} alt={name} className="h-full w-full object-cover" loading="lazy" />
                                  ) : (
                                    <div className="grid h-full w-full place-items-center text-xs text-white/40">Image</div>
                                  )}
